...
$command3 = "convert /var/www/betatoork/app/webroot/upload/games/1125/toork_Play_Free_Games_toorksize.jpg -quiet  -crop 200x110+30+30  +repage  /home/ubuntu/test/".$id."naber333.png";
exec($command3, $output3, $ret3);
