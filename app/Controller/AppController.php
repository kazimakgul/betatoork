...
class AppController extends Controller {
    ...
    public function beforeFilter() {
		$this->loadModel('User');
		$this->Auth->allow('index','checkUser','view','register','login','logout','play','profile','usergames','playlist','search','display','activate','reset_request','reset_now','mostplayed','toprated','categorygames','followers','subscriptions','follow_card','add_subscription','sub_check','add_play','bestChannels','playedgames','play2','randomAvatar','lastadded','allusergames','alluserfavorites','allchannelgames','allchannelfavorites','seoplay','seoplay2','channelgames','connect','sync','syncallusers','incgameplay','incscribe','togglefav','totalrate','getgamecount','potential','message_ajax','message_ajax2','moreupdates_ajax','moreupdates_ajax2','comment_ajax','image_ajax','get_userdata','delete_message_ajax','delete_comment_ajax','action_ajax','get_gamedata','moreupdates_filter_ajax','gamefeed_ajax','view_ajax','mass_subscription','quick_subscription','sync_recommended','dashboard','chains','mygames','favorites','profile','playgame','settings','bestchannels2','toprated2','add2');
