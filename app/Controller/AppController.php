...
class AppController extends Controller {
    ...
    public function beforeFilter() {
		$this->loadModel('User');
		$this->Auth->allow('index','checkUser','view','register','login','logout','play','profile','usergames','playlist','search',
            ...
            'sync_recommended','profile','playgame','bestchannels2','toprated2');
