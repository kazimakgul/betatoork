...
class AppController extends Controller {
    ...
    var $paginate = array(
        ...
        'Favorite' => array('contain'=>array('Game'=>array('fields'=>array('Game.name,Game.seo_url,Game.id,Game.picture,Game.starsize'),'Category','User'=>array('fields'=>array('User.username','User.seo_username')))),
            'limit' => 28,
            'order' => array(
