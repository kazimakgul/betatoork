...
class AppController extends Controller {
    ...
    public function beforeFilter() {
		...
		$this->Auth->allow('index','checkUser','checkUser2','FaceUser','gatekeeper','usernameAvailable','view','register','logout','play','profile','usergames','playlist',
            ...
            'togglelast10','featuredchannels','getOldNotifications','hashtag','register2','login3','explore','faceregister','fblogin','metacrawler','likeswitch','getlikestatus','sharepost','gamerepair');
