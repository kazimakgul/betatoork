...
class AppController extends Controller {
    ...
    public function beforeFilter() {
		...
		$this->Auth->allow('index','checkUser','checkUser2','gatekeeper','view','register','login','logout','play','profile','usergames','playlist',
            ...
            'channelfollowers','moreupdates_profile_ajax','loadprofilefeeds','sendmail','activationmailsender','new_user','get_image_link','getscreen','cropimage','addgame_ajax','add_virtual_game','pushActivity','setPermissions','activityMessage','getFreshActivity','posts');
