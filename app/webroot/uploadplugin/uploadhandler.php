...
class UploadHandler
{
	...
	$this->options['upload_dir']=dirname($this->get_server_var('SCRIPT_FILENAME')).'/../upload/users/'.$_GET['id'].'/sss/';
	$this->options['upload_url']=$this->get_full_url().'/../upload/users/'.$_GET['id'].'/sss/';
