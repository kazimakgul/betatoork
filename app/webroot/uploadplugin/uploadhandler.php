...
class UploadHandler
{
	...
	$relative_upload_dir=dirname($this->get_server_var('SCRIPT_FILENAME')).'/../upload/';
	$relative_upload_url=$this->get_full_url().'/../upload/';
	...
	if(isset($_GET['uploadtype']) && $_GET['uploadtype']=="avatar_image" && isset($_GET['id']))
	{
	...
	$this->options['upload_dir']=dirname($this->get_server_var('SCRIPT_FILENAME')).'/../upload/users/'.$_GET['id'].'/covers/';
	$this->options['upload_url']=$this->get_full_url().'/../upload/users/'.$_GET['id'].'/covers/';
