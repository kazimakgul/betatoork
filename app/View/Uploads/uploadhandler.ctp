...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {echo '<br>'.$this->get_full_url().'/';echo '<br>'.dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/';echo '<br>'.$this->get_full_url().'/files/'.'<br><br>';
