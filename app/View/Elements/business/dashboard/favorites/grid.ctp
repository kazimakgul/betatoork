    ...
    foreach ($games as $game) {
        ...
        <div class="col-xs-12 col-sm-6 col-md-4" id="gamebox-<?php echo $id; ?>">
            <div class="panel panel-default">
                <!--
                <a href="#">
                    <div style="padding:80px; background-size:contain; background-position:center; background-size: 100%; background-image:url(https://s3.amazonaws.com/betatoorkpics/upload/games/168/toork_Kamikaze_Pigs_toorksize.png)" class="panel-heading"></div>
                </a>
                -->
                ...
                <div class="panel-body" style="padding-top:0px;">
                    ...
                    <div class="favourite">
                        <div class="widget-button">
                            <!-- <button type="button" class="btn btn-default" id="fav-<?php echo $game['Game']['id']; ?>" onclick="favorite('<?php echo $game['Game']['name']; ?>', user_auth, <?php echo $game['Game']['id']; ?>);"><li class="fa fa-heart <?php if(isset($ownuser[0]['favorites']['id'])){echo 'red';}?>"></li> UnFavorite <span class="label label-info" id="fav_count"><?= $game['Gamestat']['favcount']; ?></span></button> -->
                            <button type="button" class="btn btn-danger" id="fav-<?php echo $game['Game']['id']; ?>" onclick="favorite('<?php echo $game['Game']['name']; ?>', user_auth, <?php echo $game['Game']['id']; ?>);"><li class="fa fa-heart <?php if(isset($ownuser[0]['favorites']['id'])){echo 'red';}?>"></li> Favorite <span class="label label-info" id="fav_count"><?= $game['Gamestat']['favcount']; ?></span></button>
                        </div>
                    </div>
                    <!-- Favorite Button  End-->
                </div>
