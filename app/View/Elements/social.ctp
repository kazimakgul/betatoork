...
<li>
<a href="https://twitter.com/share" class="twitter-share-button" data-count="vertical" data-url="<?php echo Router::url( $this->here, true ); ?>" data-via="toork">Tweet</a>
