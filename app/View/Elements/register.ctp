<?php
  $regurl=$this->Html->url(array("controller" => "users","action" =>"checkUsername"));
?>

<div id="<?php echo $regurl ?>" class="t_regbox_overlay">
			...
			<div id="t_regbox_signmask" class="t_regbox_signmask">
				<div id="t_regbox_signform" class="t_regbox_signform"><!-- all forms -->
					...
					<div id="t_regbox_regcapthcaform" class="t_regbox_regcapthcaform">
							...
							<div id="recaptcha_widget">
								...
								<div class="clearfix" style="margin-left:23px;">
									<div class="recaptcha_response_field">
										<input type="text" id="recaptcha_response_field" name="recaptcha_response_field" style="width:123px; margin:0; padding:0; margin-top:4px; font-size:8pt; margin-left:5px; color:#0066CC;" />
									</div>
									<div style="float:left; margin-left:12px;">
										<a style="display:block; width:25px; height:16px; margin-top:2px;" href="javascript:Recaptcha.reload()"></a>
										<div class="recaptcha_only_if_image"><a style="display:block; width:25px; height:14px; margin-top:2px;" href="javascript:Recaptcha.switch_type('audio')"></a></div>
										<div class="recaptcha_only_if_audio"><a style="display:block; width:25px; height:14px; margin-top:2px;" href="javascript:Recaptcha.switch_type('image')"></a></div>
										<div><a style="display:block; width:25px; height:16px; margin-top:1px;" href="javascript:Recaptcha.showhelp()"></a></div>
									</div>
								</div>
							</div>
						...
						<a class="t_regbox_donebtn" id="t_regbox_signdonebtn" href="#"></a>                      
					</div>                                      
					...
					<div id="t_regbox_rememberform" class="t_regbox_rememberform">
						<div class="margin_fix" style="margin-top:10px;">
							...
							<div class="clearfix" style="width:309px; margin-top:100px;">
								...
								<a class="t_regbox_donebtn" id="t_regbox_logdonebtn" href="#"></a>                          
							</div>  
						</div>
					</div> 
				</div>            
