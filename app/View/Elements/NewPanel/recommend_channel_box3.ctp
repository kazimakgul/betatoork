  ...
  <!----=========================================---->			
			...
			<div class="span12" style="margin:0px;">
				 ...
				 <li class="header-control contact-alt grd-white" style="margin:0px 0px 3px 0px;">
                                                    ...
                                                    <button style="margin:10px 0px 0px 0px; opacity:1;" href="#" onclick="subscribe('<?php echo $card[0]; ?>',user_auth,<?php echo $followid; ?>); _gaq.push(['_trackEvent', 'Channel', 'Follow', '<?php echo $follower['User']['username']; ?>']);"  rel="tooltip" data-placement="left" data-original-title="Follow" data-box="close" data-hide="fadeOut" class="close"><i class="elusive-plus-sign color-green"></i></button> 
