                        ...
                        <!--panel button ext-->
                            ...
                            <div class="pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-notification">
                                    <li class="dropdown-header grd-white"><a href="#"><i class="elusive-refresh"></i> Refresh Notifications</a></li>
                                    <li>
                                   ...
                                   <li class="dropdown-footer"><a href=""><i class="elusive-download-alt"></i> Load More Notifications</a></li>
                                </ul><!--notification-->
                            </div>
