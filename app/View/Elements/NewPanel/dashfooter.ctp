...
<div class="well well-small" style="opacity:0.6; margin:0px 0px 0px 0px; text-align: center ;">
    ...
    <a href="#" class="btn btn-link"><small>Terms</small></a>
        </li>
        <li style="display: inline;">
    <a href="#" class="btn btn-link"><small>Privacy</small></a>
        </li>
        <li style="display: inline;">
    <a href="#" class="btn btn-link"><small>Support</small></a>
        </li>
        <li style="display: inline;">
    <a href="#" class="btn btn-link"><small>Developers</small></a>
        </li>
        <li style="display: inline;">
    <a href="#" class="btn btn-link"><small>Advertise</small></a>
        </li>
        <li style="display: inline;">
    <a href="#" class="btn btn-link"><small>FAQs</small></a>
        </li>
    </ul>
