...
<div style=" margin:0px; padding:10px;" id="my_more_home<?php echo $msg_id; ?>">
<a style="display:none;" href="#" class="btn btn-small btn-link profile_more2" id="<?php echo $msg_id; ?>"> <i class="elusive-refresh"></i> View More Posts</a>
</div>
<?php } ?>
