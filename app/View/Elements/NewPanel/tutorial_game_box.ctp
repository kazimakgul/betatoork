      ...
      <div class="span6" style="margin:0px;">
         ...
         <li class="header-control contact-alt grd-white" style="margin:0px 10px 10px 0px;">
              ...
              ?>
                                                    ...
                                                    <button style="margin:-28px 5px 0px 0px; opacity:1;" href="#" rel="tooltip" data-placement="left" data-original-title="Chain" data-box="close" data-hide="fadeOut" class="close"><i class="btn btn-info btn-mini helper-font-16 icofont-link"></i></button> 
                                                    </a>
                                                </li>       
