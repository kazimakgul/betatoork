...
<div style="background-color:#f5f5f5; padding:30px; margin:-20px;">				
			...
			<div class="row-fluid commentupdate clearfix" style='margin-left: -15px; margin-top: 10px; display:none' id='commentbox2<?php echo $msg_id;?>'>
...
<a href="#" class="btn btn-small btn-link my_more" id="<?php echo $msg_id; ?>"> <i class="elusive-refresh"></i> View More Posts</a>
</div>
