<?php if($favorites==NULL){ echo "<div class='elusive-heart color-red media well shadow span6' style='background-color:white;'> You have't favorited any games yet.</div>";} ?>
...
<!----Declare Channel Name For JavaScript Usage---->
  ...
  <!----=========================================---->
              ...
              <li class="span3 header-control" style="margin:0px 8px 0px 8px;">
                <div class="navbar"><div class="well" style="background-color:white; padding:0px 0px 25px 0px;">
