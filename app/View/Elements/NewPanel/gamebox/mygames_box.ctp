...
<?php $deleteurl=$this->Html->url(array( "controller" => "games","action" =>"delete",h($game['Game']['id']))); ?>
              ...
              <?php } ?>
                <div class="navbar"><div class="navbar-inner" style="padding:10px 10px 5px 10px;">
                  <a href="<?php echo $playurl ?>"><?php echo $this->Upload->image($game,'Game.picture',array('style' => 'toorksize'),array('alt'=>$game['Game']['name'],'width'=>'200px','height'=>'110px','onerror'=>'imgError(this,"toorksize");')); ?></a>
                  <div class="caption">
