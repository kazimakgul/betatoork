...
<?php echo $this->Upload->image($game,'Game.picture',array('style' => 'toorksize'),array('class'=>'img-polaroid','width'=>'190px','onerror'=>'imgError(this,"toorksize");')); ?>
      <button onclick="chaingame2('<?php echo $game['Game']['name']; ?>',user_auth,<?php echo $game['Game']['id']; ?>); _gaq.push(['_trackEvent', 'Games', 'Chain', '<?php echo $game['Game']['name']; ?>']);" style="margin:5px; opacity:1;" href="#" rel="tooltip" data-placement="left" data-original-title="Chain" data-box="close" data-hide="fadeOut" class="close"><i class="btn btn-success btn-mini helper-font-16 icofont-link"></i></button> 
