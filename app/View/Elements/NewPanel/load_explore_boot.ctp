...
{
	$updatesarray=$Wall->Explore_Updates($uid,$lastid,$type);
	$total=50;
...
<a href="#" class="btn btn-small btn-link explore_more" id="<?php echo $msg_id; ?>"> <i class="elusive-refresh"></i> View More Posts</a>
</div>
