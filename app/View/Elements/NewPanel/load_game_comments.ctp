...
if(isset($uid))
{
	$updatesarray=$Wall->Game_Comments($uid,$lastid,10,$game_id);
	$total=50;
}
...
if($updatesarray)
{
	foreach($updatesarray as $data)
	{
		...
		// End Avatar
?>
<div class="media well" id="stbody2<?php echo $msg_id;?>">
...
<a href="#" class="btn btn-small btn-link pull-right more_game_comments" id="<?php echo $msg_id; ?>">View more &rarr;</a>
</div>
