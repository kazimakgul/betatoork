...
<head>
    ...
    <![endif]-->
		...
		<?php echo $this->Html->script(array('business/dashboard/bootstrap/bootstrap.min.js','business/dashboard/vendor/jquery.cookie.js','business/dashboard/vendor/moment.min.js','business/dashboard/theme.js','business/dashboard/vendor/bootstrap-datepicker.js','business/dashboard/vendor/raphael-min.js','business/dashboard/vendor/morris.min.js','business/dashboard/vendor/jquery.flot/jquery.flot.js','business/dashboard/vendor/jquery.flot/jquery.flot.time.js','business/dashboard/vendor/jquery.flot/jquery.flot.tooltip.js','business/dashboard/custom.js')); ?>
