...
<?php  echo $this->element('NewPanel/rightpanel',array('bestchannels'=>$bestchannels)); ?>
...
profile_news_var='<?php echo $this->Html->url(array('controller'=>'wallentries','action'=>'moreupdates_profile_ajax',$profile_uid));?>';
