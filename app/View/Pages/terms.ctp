...
Use, reproduction, modification, distribution or storage of any Content other than use strictly in accordance with the Terms of Service is expressly prohibited without prior written permission from Company, or from the copyright holder identified in such Content's copyright notice. You shall not sell, license, rent, or otherwise use or exploit any Content in any way that violates any third party right.
                        ...
                        <h4>Third Party Intellectual Property — Copyright Notifications</h4>
...
a description of where the material that you claim is infringing is located on the Clone Site, sufficient for Company to locate the material;
...
You acknowledge that Clone owns all right, title and interest in and to the Services, including without limitation, Website, and all underlying software and technology, including without limitation all Intellectual Property Rights. “Intellectual Property Rights” means any and all rights existing from time to time under patent law, copyright law, trade secret law, trademark law, unfair competition law, and any and all other proprietary rights, and any and all applications, renewals, extensions and restorations thereof, now or hereafter in force and effect worldwide.
...
Except for that Content that is owned by you, that is in the public domain, for which you have been given written permission, or as expressly permitted under this Agreement, you agree not to (i) modify, publish, transmit, distribute, perform, sell, or create derivative works based on the Content and Services; and (ii) rent, lease, loan, or sell access to the Services; (iii) decompile, reverse engineer, or copy any Content (other than the Content you provide) or the Services for which the source code is not provided to you. You also agree to not remove, obscure, or alter Clone’s copyright notice, trademarks, or other proprietary rights notices affixed to. You will not: (i) cover or obscure the banner advertisements on your Clone Channel page, or any Clone page via HTML/CSS, scripting, or any other means, if any or (ii) interfere with, disrupt, or create an undue burden on the Services or the networks or services connected to the Services.

                        </small></p>
                        
                        <h4>5 OBJECTIONABLE CONTENT</h4>
...
You are solely responsible for any and all Content that is published or displayed (“posted“, as used herein) by or through your Clone Channel on the Services, including any e-mail, and for your interactions with other Users.
...
Accessing the Service is prohibited from territories where the Content is illegal. If you access the Service from other locations, you do so at your own risk and are responsible for compliance with local laws.
                        ...
                        <h4>Electronic Delivery/Notice Policy and Your Consent</h4>
