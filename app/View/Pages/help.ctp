...
<p class="alert alert-danger"><span class="label label-danger">Idiot</span> I don’t know how you come so far but please put your mouse down slowly and ask some one to log you out.</p>
...
<p class="alert alert-danger"><span class="label label-danger">Idiot</span> Go to kitchen and see if you are there or not ? </>
