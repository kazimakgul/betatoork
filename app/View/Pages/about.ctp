...
contact us at <a href="mailto:siteowner@toork.com">siteowner@toork.com</a> to be able to publish your own games and pages.
                      </p>
                      <br />
                      <h1>Wanna talk to us?</h1>
                      <p>
            Shoot us an email at <a href="mailto:hello@toork.com">hello@toork.com</a>
                      </p>
                      <br />
