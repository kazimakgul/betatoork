		...
		<div id="content">
			<div class="menubar">
				...
				<div class="page-title">
					Time to upgrade your plan <small>(Become a Pro)</small>
				</div>
			</div>
			...
			<div class="content-wrapper">
				...
				<div class="pricing-wizard">
					<h4>One step away from being a professional</h4>
					...
					<div class="step-panel billing">
						<div class="secure clearfix">
							...
							<div class="accepted-cards pull-right">
								<img src="http://wolfadmin.herokuapp.com/assets/credit_card_types-4956c540c4db81e890e0fe4b5dfa61d1.gif" />
							</div>
						</div>
