			...
			<div class="content-wrapper">
				...
				<div class="row users-list">
					<div class="col-md-12">
						<div class="row headers">
							...
							<div class="col-sm-3 header hidden-xs">
								<label><a href="#">Clones</a></label>
							</div>
							<div class="col-sm-2 header hidden-xs">
								<label><a href="#">Favorites</a></label>
							</div>
							<div class="col-sm-2 header hidden-xs">
								<label class="text-right"><a href="#">Plays</a></label>
							</div>
						</div>
						<div class="row user">
							...
							<div class="col-sm-3">
								<a href="user-profile.html" class="name">Super Mario Bros 17</a>
							</div>
							<div class="col-sm-3">
				...
				<div class="row users-grid">
					<div class="user col-sm-3 col-xs-6">
						<a href="#">
							<img src="http://wolfadmin.herokuapp.com/assets/avatars/3-92c3675516dd81ac898a7064ee9636bc.jpg" />
						</a>
					...
					<div class="user col-sm-3 col-xs-6">
						<a href="#">
							<img src="http://wolfadmin.herokuapp.com/assets/avatars/10-dfab47b3ebee731d5dc45ace37acbefd.jpg" />
						</a>
