            ...
            <form id="game_add" class="form-horizontal" method="post" action="#" role="form">
                        ...
                        <div class="well">
                            <div class="pic">
                                ...
                                if ($game['Game']['picture'] != NULL && $game['Game']['picture'] != '') {
                                    ...
                                    $bg_exist = 1;
                                    echo $this->Upload->image($game, 'Game.picture', array('style' => 'toorksize'), array('alt' => $game['Game']['name'], 'id' => 'game_image', 'data-src' => 'current', 'style' => 'width:215px;height:118px;', 'onerror' => 'imgError(this,"toorksize");'));
                                } else {
                ...
                <div class="address">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 col-md-4">
                            <input type="text" class="form-control" id="game_link" maxlength="200" placeholder="Ex:http://socialesman.com" name="address" value="<?php echo $game['Game']['link']; ?>" <?php if ($game['Game']['install']) {
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id="fullscreen" name="send_marketing" <?php if ($game['Game']['fullscreen']) {
    echo 'checked';
} ?> /> Full Screen
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id="mobile" name="send_marketing" <?php if ($game['Game']['mobileready']) {
    echo 'checked';
} ?> /> Mobile Ready
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id="installable" class="installable" name="send_marketing" <?php if ($game['Game']['install']) {
    echo 'checked';
} ?> /> Installable
                ...
                <div class="app_details" style='<?php if ($game['Game']['install']) {
    echo 'display:block';
} else {
    echo 'display:none';
} ?>'>
                ...
                <div class="form-group form-actions">
                    <div class="col-sm-offset-2 col-sm-10 col-md-offset-2 col-md-10">
                        <button id="NewButton1" class="NewButton btn btn-success">Save And Publish</button>
                        <button id="NewButton2" class="NewButton btn btn-warning">Save As Draft</button>
