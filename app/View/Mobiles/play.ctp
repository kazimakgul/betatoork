...
<div id="content" class="snap-content">
    <a class="btn" style="background-color: transparent;" href="javascript:;" id="open-left"><i style="color:white; position:fixed;  z-index:9999999;" class="fa fa-bars fa-2x"></i></a>
