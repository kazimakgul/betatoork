...
<div align="center" style="background-color:#e0dad5;margin-bottom:15px;padding:10px 10px 10px 10px">
  ...
  </a></td><td style="padding-left:14px"><div style="font:14px arial;font-weight:bold;color:#262626"><a href="<?php echo $profileurl; ?>" style="color:#262626;font:16px arial,normal;text-decoration:none" target="_blank"><?php echo $performer['User']['seo_username']; ?></a></div><div style="font:11px arial,normal;color:#999999;margin-top:3px">I like the post you shared.</div></td></tr></tbody></table>
  </div>
