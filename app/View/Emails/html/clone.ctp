...
<div align="center" style="background-color:#e5e5e5;margin-bottom:15px;padding:10px 10px 10px 10px">
  ...
  <div style="padding:0px 12px;border-bottom:1px solid #f1f1f1">
    <table style="width:100%;min-height:50px" cellpadding="0" cellspacing="0"><tbody><tr><td style="font-size:18px"><p style="font-family:'helvetica neue'; font-weight:bold;font-size:16px;">Your game has a new clone now.</p></td></tr></tbody>
    </table>
  </div>
  ...
  </a></td><td style="padding-left:14px"><div style="font:14px arial;font-weight:bold;color:#262626"><a href="<?php echo $profileurl; ?>" style="color:#262626;font:16px arial,normal;text-decoration:none" target="_blank"><?php echo $performer['User']['seo_username']; ?></a></div><div style="font:11px arial,normal;color:#999999;margin-top:3px">Cloned your game now.</div></td></tr></tbody></table>
  </div>
