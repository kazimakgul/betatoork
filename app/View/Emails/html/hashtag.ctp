...
<div align="center" style="background-color:#e5e5e5;margin-bottom:15px;padding:10px 10px 10px 10px">
  ...
  <div style="padding:0px 12px;border-bottom:1px solid #f1f1f1">
    <table style="width:100%;min-height:50px" cellpadding="0" cellspacing="0"><tbody><tr><td style="font-size:18px"><p style="font-family:'helvetica neue'; font-weight:bold;font-size:16px;"><?php echo $performer['User']['username']; ?> is talking about <?php echo $game['Game']['name']; ?> </p></td></tr></tbody>
    </table>
  </div>
  ...
  </a></td><td style="padding-left:14px"><div style="font:14px arial;font-weight:bold;color:#262626"><a href="<?php echo $profileurl; ?>" style="color:#262626;font:16px arial,normal;text-decoration:none" target="_blank">
  <?php echo $performer['User']['username']; ?></a></div><div style="font:11px arial,normal;color:#999999;margin-top:3px">is talking about your game: <?php echo $game['Game']['name']; ?> </div></td></tr></tbody></table>
  </div>

  <div style="padding:14px"><table style="width:100%" cellpadding="0" cellspacing="0"><tbody><tr><td><div style="padding-right:20px;display:inline-block;font-size:16px"><a href="#" style="color:inherit;text-decoration:none" target="_blank"><?php echo $perstat['Userstat']['subscribeto'];?> Followers </a></div><div style="padding-right:20px;display:inline-block;font-size:16px"><a href="#" style="color:inherit;text-decoration:none" target="_blank"><?php echo $perstat['Userstat']['uploadcount'];?> Games</a></div> <td style="text-align:right"><a href="http://toork.com<?php echo $profileurl; ?>" style="background-color:#f5f5f5;border:solid 1px #dfdfdf;border-radius:3px;color:#444;display:inline-block;font-family:Arial;font-size:13px;font-weight:bold;min-height:34px;line-height:34px;min-width:54px;padding:0 20px;text-align:center;text-decoration:none;white-space:nowrap" target="_blank">View Post</a></td></td></tr></tbody></table></div></div></div>

  <div style="max-width:520px">
  <div style="background-color:white;border:1px solid #dadada;border-bottom-width:2px;border-top:none">
  <div style="padding:0px 12px;border-bottom:1px solid #f1f1f1">
    <table style="width:100%;min-height:50px" cellpadding="0" cellspacing="0"><tbody><tr><td><p><a href="http://toork.com" style="color:#2f96b4; font-family:'helvetica neue',helvetica,arial,sans-serif;font-weight:bold;font-size:18px;line-height:18px; text-decoration:none">toork.com</a> - create your own game channel</p></td></tr></tbody>
    </table>
  </div>
  </div>
  </div>
 ...
 <p style="font-family:'helvetica neue',helvetica,arial,sans-serif;font-size:10px;color:#999999;line-height:1.35em;margin:0;padding:0">This email was sent to <?php echo $perMail; ?>.<br><a href="http://toork.com" style="color:#999;text-decoration:underline" target="_blank">Change your email preferences.</a></p>
