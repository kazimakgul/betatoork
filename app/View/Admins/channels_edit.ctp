            ...
            <div class="address">
                <div class="form-group">
                    ...
                    <div class="col-sm-5 col-md-4">
                        <input type="text" class="form-control" id="game_link" maxlength="200" placeholder="Ex:http://socialesman.com" name="address" value="<?php echo $game['Game']['link']; ?>" <?php
