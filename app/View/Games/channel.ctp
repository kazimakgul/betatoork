  ...
  <div class="channel_right_panel">
        ...
        <div id="channelgames">
			...
			<?php if(count($mygames) >= 1){ ?>
				<ul>
					<li class="clearfix"><?php echo $this->element('mygames_game_box'); ?></li>
				</ul>
			<?php } else { ?>
		...
		<div id="favoritegames">
			...
			<?php if(count($favorites) >= 1){ ?>
				<ul>
					<li class="clearfix"><?php echo $this->element('favorites_game_box'); ?></li>
				</ul>
            <?php } else { ?>
		...
		<div id="subscriber">
			...
			<?php if(count($users) >= 1){ ?>
				<ul>
					<li class="clearfix"><?php echo $this->element('channelgames_sub_card'); ?></li>
				</ul>
            ...
            <?php } else { ?>
				<div class="alert alert-info channel">You dont have any Chains yet, Please check our best channels to get connected to your favorite channels. 
					<div id="addButton"> <a href="<?php echo $best ?>"><input type="submit" id="submit" value="Best Channels"></a></div>
				</div>
			<?php }?>		
		</div>
		<div class="clear"></div>
