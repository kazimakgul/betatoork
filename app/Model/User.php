...
var $virtualFields = array('uploadcount' => 'SELECT COUNT(id) FROM games where games.user_id=User.id','totalrate'=>'(SELECT SUM(current) FROM rates where rates.game_id IN (SELECT id FROM games where games.user_id=User.id))','favoritenumber'=>'SELECT COUNT(id) FROM favorites where favorites.user_id=User.id','subscribe'=>'SELECT COUNT(id) FROM subscriptions where subscriptions.subscriber_id=User.id','subscribeto'=>'SELECT COUNT(id) FROM subscriptions where subscriptions.subscriber_to_id=User.id','playcount'=>'SELECT COUNT(id) FROM playcounts where playcounts.subscriber_to_id=user_id');
