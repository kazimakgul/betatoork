...
<html>
    <head>
        ...
        ?>
        <script>
            var games_edit_post     = '<?php echo $this->Html->url(array('plugin'=>'clone_admin','controller' => 'admins', 'action' => 'games_edit_post')); ?>';
            var channels_edit_post  = '<?php echo $this->Html->url(array('plugin'=>'clone_admin','controller' => 'admins', 'action' => 'channels_edit_post')); ?>';
            var add_mapping         = '<?php echo $this->Html->url(array('plugin'=>'clone_admin','controller' => 'businesses', 'action' => 'add_mapping')); ?>';
            var remove_mapping      = '<?php echo $this->Html->url(array('plugin'=>'clone_admin','controller' => 'businesses', 'action' => 'remove_mapping')); ?>';
            var remove_game      = '<?php echo $this->Html->url(array('plugin'=>'clone_admin','controller' => 'businesses', 'action' => 'deletedata')); ?>';
