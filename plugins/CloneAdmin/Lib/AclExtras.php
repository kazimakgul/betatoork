 ...
 * @note from ogi Bu fonksiyonda bazı değişiklikler yaparak tüm action isimlerinin küçük harf olmasını sağladım!
 * @return void
 */
	public function _checkMethods($className, $controllerName, $node, $pluginPath = false) {
		...
		$methods = array_map('strtolower', $methods);//This func makes array lowercase!
