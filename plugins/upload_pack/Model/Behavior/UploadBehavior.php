...
/**
 * This file is a part of UploadPack - a plugin that makes file upload in CakePHP as easy as possible.
 *
 * UploadBehavior
 *
...
class UploadBehavior extends ModelBehavior {
    ...
    public function setup(&$model, $settings = array()) {
        $defaults = array(
            'path' => ':s3.amazonaws.com/betatoorkpics/upload/:model/:id/:basename_:style.:extension',
